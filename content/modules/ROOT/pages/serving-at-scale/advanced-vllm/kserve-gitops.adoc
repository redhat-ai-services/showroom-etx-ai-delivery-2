...
[source,bash,role="execute"]
----
helm upgrade -i granite-guardian -n vllm redhat-ai-services/vllm-kserve --version 0.5.10 \
...
[source,bash,role="execute"]
----
helm upgrade -i granite-8b -n vllm redhat-ai-services/vllm-kserve --version 0.5.10 \
...
====
```
helm upgrade -i vllm-multi-node-llama -n vllm redhat-ai-services/vllm-kserve --version 0.5.10 \
